...
const options = [{ value: "pending", label: "Orçamento" }, { value: "confirmed", label: "Confirmado" }, { value: "production", label: "Em produção" }, { value: "finished", label: "Concluído" }, { value: "delivered", label: "Entregue" }, { value: "cancelled", label: "Cancelado" }];
