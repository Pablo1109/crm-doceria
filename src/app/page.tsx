import { db } from "@/db";
import { ingredients, orders, stockBatches } from "@/db/schema";
...
export default async function DashboardPage() {
  ...
  const batches = await db.select({ ingredientId: stockBatches.ingredientId, totalQuantity: stockBatches.totalQuantity }).from(stockBatches).innerJoin(ingredients, eq(stockBatches.ingredientId, ingredients.id));
