...
import { CalendarDays, ChefHat, ClipboardList, Home, Menu, Package, Sparkles, WalletCards, X } from "lucide-react";
const icons: Record<string, ElementType> = { Home, ClipboardList, ChefHat, Package, CalendarDays, WalletCards };
